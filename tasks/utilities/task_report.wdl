...
task make_pdf {
  ...
  command <<<
    ...
    html_output += "<style>table{border-collapse: collapse;width: 100%;} th, td{text-align: left; padding: 4px;} td{overflow-wrap: break-word; word-break: break-all} tr:nth-child(even){background-color: #EDEDED;} .page-break-after{page-break-after:always;} p{line-height: 0.5;} @media print{.page-break-after:last-child{page-break-after:avoid;}}</style>"
    ...
    for entity in samples:
      ...
      html_output += "<div class=\"page-break-after\"><h1>" + table["sample"][0] + "</h1>"
      html_output += "<p>Report generated by <b>" + table["analyst_name"][0] + "</b> on <b>" + str(date.today().isoformat()) + "</b></p>"
